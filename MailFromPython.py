...
letter["From"] = "Александр Мироненко"
...
attachement.set_payload(open("C:\Учеба\PythonPro\ege.best.pdf", "rb").read())
attachement.add_header("Content-Disposition",
                      'attachement; filename="ege.best.pdf"')
encoders.encode_base64(attachement)
letter.attach(attachement)
user = "icanflyman1794@gmail.com"
password = "ih'rshrek5328!"
server = smtplib.SMTP_SSL("smtp.gmail.com", 465)
server.login(user, password)
server.sendmail("icanflyman1794@gmail.com", "support@ittensive.com", letter.as_string())
server.quit()