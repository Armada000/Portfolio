...
data1=data1.set_index(['Period', 'Year'])
data2=data2.set_index(['AdmArea','Month', 'Year'])
data2 = data2.loc['Центральный административный округ']
data2.index.names=['Period', 'Year']
data=pd.merge(data1,data2,left_index=True, right_index=True)
data=data.reset_index().set_index(['Calls']).sort_index()
